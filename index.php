...
<body style="margin-bottom:200px">
        ...
        <div id="bg" class=" ">
            <div class="container" style="padding-top:150px">
                <div class="mx-auto p-5 text-white" id="banner_content" style="border-radius: 0.5rem;" >
                    <h1 style="font-size: 45px;">You'll find everything you need - and more!</h1>
                    <p style="font-size: 30px;">The best prices in town - guaranteed! </p>
                    <p><mark>Flat 20% OFF for new users :)</mark></p>
    ...
    <div class="text-center pt-4 h3">
        * Fashion At Your Fingertips, With Quality You Can Trust *
    </div>
